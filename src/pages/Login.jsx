...
// NOTE: Attendance (in-time/out-time) is no longer captured here. Signing in
// just authenticates the user and drops them on the dashboard. Once there,
// the navbar shows an "In Time" button — clicking it is what opens the
// camera + captures location and actually starts the attendance session.
// See TopNavbar.jsx for that flow.
const Login = () => {
  ...
  // If real auth already exists, the user is genuinely logged in → send
  // them straight to the dashboard instead of showing the login form again.
  useEffect(() => {
